		...
		<ul class="sub-list">
			<?php if(isset($socialicons)) {
					...
					<li data-display="half">
						...
						<input data-display="half" id="social-network" class="exclude uk-form uk-form-large uk-form-width-large" value="<?php echo $url;?>"/>		
