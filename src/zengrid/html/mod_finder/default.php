...
{
	$label = '<label for="mod-finder-searchword" class="finder' . $suffix . ' form-label-'.$params->get('label_pos', 'left').'">' . $params->get('alt_label', JText::_('JSEARCH_FILTER_SUBMIT')) . '</label>';
