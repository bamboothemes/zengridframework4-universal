	...
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form">
		...
		<fieldset class="userdata">
				...
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-user zen-icon zen-icon-user tip" title="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>"></i>
						</span>
			...
			<div id="form-login-password" class="form-group">
				...
				<div class="input-group">
						<span class="input-group-addon">
							<i class="fa fa-lock zen-icon zen-icon-lock tip" title="<?php echo JText::_('JGLOBAL_PASSWORD') ?>"></i>
						</span>
			...
			<ul class="stacked">
				...
				<li>
					<a href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>">
						<?php echo JText::_('MOD_LOGIN_REGISTER'); ?> <span class="zen-icon zen-arrow-right fa fa-arrow-right"></span></a>
				</li>
				<?php endif; ?>
				<li>
