...
?>
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search'); ?>" method="post" role="search">
	...
	<div class="input-group form-group">
		...
		<span class="input-group-btn">
			<button name="Search" onclick="this.form.submit()" class="btn btn-default"
					title="<?php echo JText::_('COM_SEARCH_SEARCH'); ?>"><?php echo JText::_('COM_SEARCH_SEARCH'); ?></button>
		</span>
	</div>
		...
		<?php } ?>
			<fieldset class="phrases">
				...
				<div class="phrases-box form-group">
					<?php echo str_replace('class="radio"', '', $this->lists['searchphrase']); ?>
				</div>
