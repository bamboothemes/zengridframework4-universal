...
<li>
	<h2 class="result-title <?php echo $mime; ?>">
	...
	<?php if ($this->params->get('show_url', 1)) : ?>
		<div class="small muted result-url<?php echo $this->pageclass_sfx; ?>">
			<a href="<?php echo $this->baseUrl, JRoute::_($this->result->route); ?>"><?php echo $this->baseUrl, JRoute::_($this->result->route); ?></a>
		</div>
	<?php endif; ?>
</li>
